...
BOOL CServerGameDesk::LoadDeskCfg()
{
	...
	if (!G_bTestSetActionProbInit)
	{
		...
		G_bTestSetActionProb = f.GetKeyVal(strSeg, "TestSetActionProb", 1);
	}


	//奖池配置
	m_bAIWinAndLostAutoCtrl = f.GetKeyVal(strSeg,"AIWinAndLostAutoCtrl",1);				//机器人输赢控制20121122dwj
	...
	m_iAIWinLuckyAtA1		= f.GetKeyVal(strSeg,"AIWinLuckyAtA1 ",75);					/**<机器人在区域1赢钱的概率  */
	m_iAIWinLuckyAtA2		= f.GetKeyVal(strSeg,"AIWinLuckyAtA2 ",70);					/**<机器人输赢控制：机器人在区域2赢钱的概率  */
	m_iAIWinLuckyAtA3		= f.GetKeyVal(strSeg,"AIWinLuckyAtA3 ",65);					/**<机器人输赢控制：机器人在区域3赢钱的概率  */
	m_iAIWinLuckyAtA4		= f.GetKeyVal(strSeg,"AIWinLuckyAtA4 ",60);					/**<机器人输赢控制：机器人在区域4赢钱的概率  */
...
BOOL CServerGameDesk::LoadDeskCfg(int iRoomID, bool bConfigRC)
{
	...
	//pDeskCfg->dz.iBigBlindNote = 2000;
	//pDeskCfg->dz.iSmallBlindNote = 1000;
