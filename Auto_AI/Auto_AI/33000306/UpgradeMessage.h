...
//游戏信息
#define NAME_ID							33000306							//名字 ID
#define CLIENT_DLL_NAME					TEXT("30030800.ico")
#define SERVER_DLL_NAME					TEXT("30030800.dll")
...
#define SKIN_FOLDER						TEXT("33000306")			//图片文件夹
...
#define GS_CONTRIBUTE                   21                          //进贡状态
#define GS_BACKCONTRIBUT                22                          //退贡状态
#define GS_WAIT_BACK					23							//等待扣压底牌(顿一手中为等待叫分状态)
#define GS_PLAY_GAME					24							//游戏中状态
