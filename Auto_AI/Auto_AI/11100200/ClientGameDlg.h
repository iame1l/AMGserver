...
public:
	...
	__int64				m_i64LimitMoney;		///<上庄需要的最少金币

	int					m_iNowNtStation;		///当前庄家的位置
	int					m_iNtPlayCount;			//庄家坐庄次数
	__int64				m_i64NtMoney;			//庄家金币
	__int64				m_i64NtWinMoney;		//庄家输赢情况
	
	BYTE				m_byZhuangList[PLAY_COUNT];		///上庄列表

	__int64				m_i64MaxNote;				///当前房间最大能下的总注
...
private:
	...
	int					m_iAreasPercent[BET_ARES];	//8个下注区域的概率
