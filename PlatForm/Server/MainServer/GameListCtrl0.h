...
public:
	...
	bool UpdateGameList();
	//更新游戏列表（数据库线程调用）
	bool UpdateGameListBuffer(IDBEngineSink* pEngineSink);
...
public:
	...
	//更新函数
public:
	INT_PTR GetContestCount() { return map_ContestList.size(); }
	//
	bool GetContestList(MSG_GP_ContestApplyInfo * pContestList,MSG_GP_ContestApplyList* pApplyInfo);
};
