...
#ifndef MAINMANAGE_H_FILE
#define MAINMANAGE_H_FILE
...
///基础数据管理类
class AFX_EXT_CLASS CBaseMainManage : public IServerSocketService , public IDataBaseResultService
{
	///控件变量
protected:
	bool									m_bRun;						///运行标志
