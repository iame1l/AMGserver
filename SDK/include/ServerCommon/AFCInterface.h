...
//服务器网络服务接口 
interface IServerSocketServiceForWeb
{
    //接口函数
public:
    //网络关闭处理
    virtual bool OnSocketCloseEvent(ULONG uAccessIP, UINT uIndex, long int lConnectTime)=0;
    //网络消息处理
    virtual bool OnSocketReadEvent(CTCPSocketForWeb * pSocket, NetMessageHead * pNetHead, void * pData, UINT uSize, UINT uIndex, DWORD dwHandleID)=0;
};
...
public:
	...
	///删除定时器啊
	virtual bool StopAllTimer() {return true;}
};
