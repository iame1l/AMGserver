...
public:
	...
	///更改用户分数
	bool ChangePoint(__int64 dwPoint, __int64 dwTaxCom, bool bWin, bool bLost, bool bMid, bool bCut, long int dwPlayCount, __int64 &dwMoney, bool bBuyDesk = false);
	///设置规则
	...
	int GetWeigth();
	//计算玩家之间距离
	int GetDistance(float flat,float flnt);
